...
func ruby266Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "ruby/2.6.6.json", size: 198, mode: os.FileMode(0644), modTime: time.Unix(1592746161, 0)}
...
func ruby271Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "ruby/2.7.1.json", size: 202, mode: os.FileMode(0644), modTime: time.Unix(1592746161, 0)}
